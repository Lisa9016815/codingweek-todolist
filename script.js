...
function makeCheckClickable() {
  ...
  checks.forEach(function (check, index) {
    ...
    check.addEventListener('click', function () {
      ...
      // if (window.confirm("Sicur* di averlo già visto?")){
      //   document.querySelector('.todo-item').innerHTML = '';
      // } else {
      //   document.querySelector('.todo-item').innerHTML = activities;
      // }


      // (window.confirm("Sicuro di averlo già visto?"))
  ...
  return `
   <li class="todo-item">
     <div class="todo-check">
       <img src="images/check3.svg" alt="Check Icon">
     </div>
